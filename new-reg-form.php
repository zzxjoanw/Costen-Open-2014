...
<html lang="en">
    <head>
        ...
        <title>Cotsen Open 2015 - Registration</title>
    ...
    <body>
        <?
            ...
            if( (isset($_POST['bttnSubmit'])) && (checkValues()) ) //form submitted properly, not paid yet
            {
                ...
                $mail->Subject = '2015 Cotsen Open registration confirmation';
